var cl = console.log;
 // var = document.getElementByclassName("movie");
...
// });
var result1 ="";
movieArray.forEach(function(movieArray1){
	result1 += `<div class="col-sm-4">
							<figure class="movie">
								<img src= "https://image.tmdb.org/t/p/w1280/${movieArray1.poster_path}" alt="img-fluid">
								<figcaption>
									<div class="movie-info">
										<div class="row">
											<div class="col-sm-10">
												<h3>${movieArray1.title}</h3>
											</div>
											<div class="col-sm-2">
												<span>${movieArray1.vote_average}</span>
											</div>
										</div>
									</div>
									<div class="overview">
